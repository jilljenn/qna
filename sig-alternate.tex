...
We are using SAT Subject Test data (like~\cite{Winters2005, Desmarais2011}) provided by Titus. This student data is a $296 \times 40$ matrix, 296 students from an unknown profile answering 40 questions from the 4 following topics: Mathematics, Biology, World History and French. These topics makes the data suitable for clustering.

For convenience we also trained on a subset $50 \times 20$ of this data.
...
For both models, we trained them using 80\% of the student data, and tried to infer the 20\% remaining data. We then compute the average log-loss.
