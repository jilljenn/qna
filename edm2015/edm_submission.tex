...
Results computed on three real datasets of growing size and different nature suggest that each model performs better on a certain type of dataset.
\end{abstract}
...
We used the SAT Subject Test data, also featured in~\cite{Winters2005, Desmarais2011} and provided by \phantom{Titus}\footnote{\phantom{\url{http://alumni.cs.ucr.edu/~titus/}}}. This student dataset is a $296 \times 40$ dichotomous matrix representing the results from 296 students on 40 questions from the 4 following topics: Mathematics, Biology, World History and French.
